    ...
    **kwargs
    ...
    if backend == 'joblib':
        ...
        try:
            ...
            logger.warning("dask_not_available", fallback="joblib")
        ...
        try:
            ...
            logger.warning("ray_not_available", fallback="joblib")
            return Parallel(n_jobs=n_jobs, verbose=verbose)(
                delayed(func)(item) for item in items
            )
...
def shap_parallel(
    ...
    def compute_shap_values(idx):
        ...
        try:
            ...
            logger.warning("shap_computation_failed", sample_idx=idx, error=str(e))
            return None
...
def ablation_parallel(
    ...
    def run_single_experiment(config_path: Path) -> dict:
        ...
        try:
            ...
            logger.warning("ablation_experiment_failed", config=config_path.name, error=str(e))
